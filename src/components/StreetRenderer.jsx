      ...
      try {
        ...
        if (numero && !esquina) {
          ...
          if (validResult) {
            ...
            console.log('Marker data from Nominatim:', validResult.display_name);
          } else {
            console.warn('No valid address found with Nominatim for Calle + Número.');
            return;
          }
        } else {
          ...
          if (intersectionNode) {
            ...
            console.log('Marker data from Overpass (intersection):', intersectionNode);
          } else {
